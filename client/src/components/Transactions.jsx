  ...
  return (
    <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          <h3 className="text-black text-3xl text-center my-2">...::: Your Transactions :::...</h3>
        ) : (
          <h5 className="text-black text-3xl text-center my-2">...::: Try to be connected to your account to see  your transactions :::...</h5>
        )}
